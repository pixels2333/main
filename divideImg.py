...
# 获取所有图片的完整路径
images = [os.path.join(original_folder, f) for f in os.listdir(original_folder) if f.lower().endswith(('.png', '.jpg', '.jpeg'))]
...
print(f'Images have been split and copied into {train_folder} and {val_folder} with an 8:2 ratio.')
